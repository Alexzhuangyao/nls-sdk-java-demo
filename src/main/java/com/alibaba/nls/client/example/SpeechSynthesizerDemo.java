...
public class SpeechSynthesizerDemo {
    ...
    public void process() {
        ...
        try {
            ...
            //TODO 换声音 这里要在阿里控制台处修改对应appkey
            synthesizer.setAppKey(appKey);
            // 设置返回音频的编码格式
            synthesizer.setFormat(OutputFormatEnum.WAV);
            // 设置返回音频的采样率  TODO 音量
            //synthesizer.setSampleRate(SampleRateEnum.SAMPLE_RATE_16K);
            synthesizer.setSampleRate(3200);
            //TODO 语速
            synthesizer.setSpeechRate(100);
            //

            // 设置用于语音合成的文本
            synthesizer.setText("国家层面是富强，民主，" +
                    "文明，和谐。社会层面是自由，平等，公正，法制。公民层面是爱国，敬业，诚信，友善。");
...
//        String token = args[1];
        ...
        SpeechSynthesizerDemo demo = new SpeechSynthesizerDemo("app-key", "token");
        demo.process();
        demo.shutdown();
    }
}
